...
export default class Answer extends Component {
    ...
    onPressQuestion = () => {
        const {correct, incorrect, pressedCorrect, pressedIncorrect} = this.state
        const backAction = NavigationActions.back({
            ...
            state: {
                    ...
                    pressedIncorrect: pressedIncorrect
            }

        })
        this.props.navigation.state.params.refresh(correct, incorrect, pressedCorrect, pressedIncorrect)
